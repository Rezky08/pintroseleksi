    ...
    <div class="columns">
        ...
        <div class="column">
            <div class="buttons is-right">
                <a href="{{ url('admin/task/create') }}" class="button is-primary">
                    <span class="icon">
            ...
            <tbody>
                @foreach ($tasks as $index => $task)
                    <tr>
                        ...
                        <td>
                            <div class="buttons">
                                <a href="{{ url('admin/task/' . $task->id, []) }}" class="button is-primary">
                                    <span class="icon">
                                        <i class="fa fa-info"></i>
                                    </span>
                                </a>
                                <a href="{{ url('admin/task/' . $task->id . '/edit') }}" class="button is-info">
                                    <span class="icon">
